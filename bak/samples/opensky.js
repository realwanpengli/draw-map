...
var OpenSkyApi = (function() {
     ...
     */
    var getFlightMapStates = function(callback, time, icao24, onfail, serial) {
        var params = {};
        if (time != null) {
   ...
   /**
     ...
     * @returns {object}
     */
     var getTrack = function(callback, icao, onfail) {
         var params = {};
        if (icao != null) {
            params.icao24 = icao;
        }
     ...
     * @returns {object}
     */
    var getSingleAirport = function(icao, callback, onfail) {
        if (icao != null) {
            _getData("airports/?icao="+icao, null, callback, onfail);
        } else {
    ...
    /**
     * Retrieve flights for a single aircraft by the icao of the aircraft.
     *
     * @memberof module:com_opensky~OpenSkyApi#
     *
     * @param {double} icao
     ...
     * @returns {object}
     */
    var getFlightsAircraft = function(icao, begin, end, callback, onfail) {
        if (icao != null) {
            var params = {
                icao24: icao,
                begin: Math.floor(begin/1000),
     ...
     * @returns {object}
     */
    var getFlightsArrivalsAirport = function(icao, begin, end, callback, onfail) {
        if (icao != null) {
            var params = {
                airport: icao,
                begin: Math.floor(begin/1000),
            ...
            console.warn("api.js: icao null was passed to getFlightsArrivalsAirport()")
        }
    };
     ...
     * @returns {object}
     */
    var getFlightsDeparturesAirport = function(icao, begin, end, callback, onfail) {
        if (icao != null) {
            var params = {
                airport: icao,
                begin: Math.floor(begin/1000),
            ...
            console.warn("api.js: icao null was passed to getFlightsDeparturesAirport()")
        }
    };
    ...
    var _setBaseUri = function(newBaseUri) {
     ...
     return {
         ...
         getFlightsArrivalsAiport: getFlightsArrivalsAirport,
         getFlightsDeparturesAirport: getFlightsDeparturesAirport,
