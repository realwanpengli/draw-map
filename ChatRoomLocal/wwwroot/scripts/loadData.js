...
function loadAircraftList(callback) {
    ...
    // setInterval(readTextFiles(callback), 5000);
    start = new Date();
    var fileName = 'aircrafthistory-2016-06-20/' + '2016-06-20-' + (indFile).pad(4) + 'Z' + '.json';
...
// function readTextFiles(callback) {

//     // get text interval
//     console.log('read files');
//     var l = 100;
//     for (var i = 0; i < l; i++) {
//         readTextFile('data2/json/aircraft-' + i + '.json', callback);
//     }
// }
