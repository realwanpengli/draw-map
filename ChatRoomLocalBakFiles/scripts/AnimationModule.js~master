...
window.Bing.Maps.Animations = new function () {
    var _delay = 2000,    //Time in ms between each frame of the animation
    ...
    function simpleAnimation(renderFrameCallback, duration) {
        ...
        /// <param name="renderFrameCallback" type="Function">A function that is called when a frame is to be rendered.</param>
        /// <param name="duration" type="Number">Length of time in ms that the animation should run for. Default is 150 ms.</param>
